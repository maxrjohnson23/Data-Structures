...
import hashtable.BasicHashTable;

public class MotorcycleOilChangeApp {
    // We will use a 12 piece socket set for this job.  Demonstrates the need to rehash on delete
    ...
    private void emptyToolset() {
        // Rehashing occurs due to small table size
        toolset.delete("8mm");
        toolset.delete("10mm");
        toolset.delete("12mm");
        toolset.delete("14mm");
    ...
    private void removeSkidPlate() {
        ...
        System.out.printf("Removed 4 skid plate nuts with the %s and %s%n", socket, wrench);
    }
    ...
    private void replaceSkidPlate() {
        ...
        String socket = toolset.get("10mm");
        String wrench = toolset.get("1/4d");
        System.out.printf("Replaced 4 skid plate nuts with the %s and %s%n", socket, wrench);
    }
